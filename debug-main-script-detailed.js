...
async function debugMainScriptDetailed() {
  console.log(`🔍 Detailed debugging of main script for ${store.name}...`);
  ...
  try {
    ...
    // Step 1: Get all summary items first
    ...
    console.log(`\n📊 All Summary Items (before extraction):`);
    ...
    // Step 2: Run the exact extraction logic from main script
    console.log(`\n🔍 Running main script extraction logic...`);
...
debugMainScriptDetailed().then((result) => {
